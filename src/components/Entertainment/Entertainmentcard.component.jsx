    ...
    return (
        <>
            <div className="w-full h-30 px-2">
                <img src={props.src} alt="entertainment img" className="w-full h-full rounded-xl" />
            </div>
        </>
    );
};
...
const EntertainmentCardSlider = () => {
    const EntertainmentImage = [
        ...
        "https://in.bmscdn.com/discovery-catalog/collections/tr:w-800,h-800:ote-MSBFdmVudA%3D%3D,otc-FFFFFF,otf-Roboto,ots-64,ox-48,oy-320,ott-b:w-300/adventure-collection-202010140844.png"
    ];
    const settings = {
        infinite: false,
        autoplay: false,
